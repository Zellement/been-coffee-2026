<template>
    <div class="container grid-layout container-px">
        <main class="content col-span-10 col-start-2">
            <h1 class="h1 mb-16">
                {{ route.fullPath }}
            </h1>
            <h2>h2 This is a Kitchen Sink - you can safely delete it</h2>
            ...
            <div class="flex gap-4">
                <UButton
                    ...
                    target="_blank"
                >
                    This is a new tab button link to Effect
                </UButton>
                <UButton label="This will console log" @click="() => console.log('loggg')" />
                <UButton
                    to="https://www.effectdigital.com"
                    variant="link"
                    label="This is a plain link to Effect"
                />
            </div>
            <hr />
            <hr />
            <p>
                ...
                <small>small</small> but there are many others as well. Hover the following text for
                abbreviation tag: <abbr title="abbreviation">abbr</abbr>. You can define
                <del>deleted text</del> which often gets replaced with <ins>inserted</ins> text.
            </p>
            <p>
                You can also use <kbd>keyboard text</kbd>, which sometimes is styled similarly to
                the <code>&lt;code&gt;</code> or <samp>samp</samp> tags. Even more specifically,
                there is a tag just for <var>variables</var>. Not to be mistaken with blockquotes
                below, the quote tag lets you denote something as <q>quoted text</q>. Lastly don't
                forget the sub (H<sub>2</sub>O) and sup (E = MC<sup>2</sup>) tags.
            </p>
            <blockquote>
                <p>
                    This is a mult-line blockquote with a cite reference. People think focus means
                    saying yes to the thing you’ve got to focus on. But that’s not what it means at
                    all. It means saying no to the hundred other good ideas that there are. You have
                    to pick carefully. I’m actually as proud of the things we haven’tdone as the
                    things I have done. Innovation is saying no to 1,000 things.
                    <cite>Steve Jobs – Apple Worldwide Developers’ Conference, 1997</cite>
                </p>
            </blockquote>
            <div class="flex flex-row gap-4">
                <UButton>This is a button</UButton>
                <UButton> This is a button </UButton>
            </div>
            <hr />
            <table>
